...
必ず全行で <metrics> と <groups> を含めて出力してください
データは大きい順に並べてください。
年や月が横軸の場合は古い順から並べてください。
期間の指定がない場合は過去10年で調査してください。
地域を示す場合は日本語で表記してください。
推移を示す場合は、年や月を横軸、指標を縦軸として出力してください。
人の生活や行動を示す場合は、性別、年齢、地域での比較を示すようにしてください。
`;
